...
class MPT(nn.Module):
    ...
    def __init__(self,
        ...
        self.mpt_mlp = nn.Linear(self.hidden_size, wte.weight.size(0))
    ...
    def forward(self, tokens):
        ...
        learned_embedding = self.mpt_mlp(torch.matmul(u, v) * self.shared_prompt)
